...
static NSString * appUrlString = @"http://www.oisy-yakuzen.jp/yakuzen/info.html";

@interface CarbCountViewController ()
...
@implementation CarbCountViewController
...
- (void)navigationBarSetting {
    ...
    [navigationBarTitleLabel setText:kNavigationBarTitleCarbCountName];
